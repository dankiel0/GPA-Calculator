...
public class Course {
	...
	public static enum Grade {
		...
		// the conversion of String values to enum values.

		// the method "valueOf(String arg0)" cannot be used because the String values have symbols in them while the enum values don't.
		...
		// converts a grade to an unweighted GPA and a weighted GPA value.
